...
function Adduser(props) {
    ...
    return (
                        ...
                        <div className='content '>
                            <div className='columns is-justify-content-center'>
                                <div className='column is-3'>
                                    <h2 className="subtitle is-2 is-semibold has-text-white has-text-centered">Create User</h2>
        ...
        /> */}
                                        ...
                                        <div>
                                            <input type="submit" value="Create User" className="button is-link is-fullwidth" />

                                            <Link to='/users'> <button type="submit" className="button is-success is-fullwidth mt-2">Back List</button></Link>
                                        </div>
